...
_C.DATALOADER_NUM_WORKERS = 0  # 0=in-process (fast for small datasets on Mac); set 8 for large datasets on CUDA
_C.PARENT_DIR = ''
...
_C.CENTERDETECT.VAL_INTERVAL = 5
...
_C.KEYPOINTDETECT.VAL_INTERVAL = 5
