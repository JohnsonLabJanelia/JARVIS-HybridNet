...
_C.HYBRIDNET.BONE_LENGTH_LOSS_WEIGHT = 0.0
_C.HYBRIDNET.USE_CROSS_VIEW_ATTENTION = False

#Temporal Refinement Transformer Configuration
_C.TEMPORAL = CN()
_C.TEMPORAL.WINDOW_SIZE = 32
_C.TEMPORAL.STRIDE = 8
_C.TEMPORAL.MAX_GAP_FRAMES = 16
_C.TEMPORAL.D_MODEL = 128
_C.TEMPORAL.NHEAD = 8
_C.TEMPORAL.NUM_LAYERS = 4
_C.TEMPORAL.DROPOUT = 0.1
_C.TEMPORAL.BATCH_SIZE = 32
_C.TEMPORAL.MAX_LEARNING_RATE = 0.001
_C.TEMPORAL.NUM_EPOCHS = 100
_C.TEMPORAL.CHECKPOINT_SAVE_INTERVAL = 10
_C.TEMPORAL.LAMBDA_POS = 1.0
_C.TEMPORAL.LAMBDA_BONE = 0.05
_C.TEMPORAL.LAMBDA_VEL = 0.01
_C.TEMPORAL.PREDICTIONS_DIR = ''
