...
def create_videos3D(params):
    ...
    if params.project_name in ["rat_pose", "rat24_3d"] or "mouse" in params.project_name:
        print("Using custom color map")
    ...
    #elif params.project_name[0:3] == "fly":
    #    colors = [(64, 224, 208), (218, 112, 214), (255, 215, 0), \
    #            (124, 252, 0), (100, 100, 100), (0, 255, 255), \
    #            (0, 0, 255), (0, 0, 255), (0, 0, 255), (0, 0, 255), \
    #            (0, 255, 0), (0, 255, 0), (0, 255, 0), (0, 255, 0), \
    #            (255, 0, 255), (255, 0, 255), (255, 0, 255), \
    #            (255, 255, 0), (255, 255, 0), (255, 255, 0), \
